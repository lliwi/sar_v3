...
def create_backup():
    ...
    try:
        ...
        try:
            ...
            # Only export essential tables to avoid crashes
            models = [
                ('users', User),
                ('roles', Role), 
                ('folders', Folder),
            ...
            current_app.logger.error(f"Error importing models: {str(import_error)}")
            models = []
...
"""
        ...
        return redirect(url_for('admin.backup_page'))            user=current_user,
            event_type='system_backup',
